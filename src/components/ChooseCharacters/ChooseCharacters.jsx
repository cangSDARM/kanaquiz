            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <ul>
                  ...
                  <li>
                    make ui more readable, like
                    <a href="https://kana-quiz.tofugu.com/" target="_blank">
                      https://kana-quiz.tofugu.com/
                    </a>
                  </li>
                  <li>
                    record time of each stage and each puzzle, make vulnerable
                    characters more likely to appear
                  </li>
                  <li>
                    replace the random characters in stage4 with real words and
                    its translations
                  </li>
                  <li>add next practice: Grammar and Vocabulary</li>
                </ul>
                <i>@AllenLee</i>
              </div>
            </div>
